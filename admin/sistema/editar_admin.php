<?php 
	...
	{
		$alert='';
		if(empty($_POST['cedula']) || empty($_POST['nombre']) || empty($_POST['apellidos']) || empty($_POST['correo']) || empty($_POST['rol']) || empty($_POST['telefono']) || empty($_POST['genero']))
		{
			...
			$query = mysqli_query($conection,"SELECT * FROM usuarios_admin WHERE correo = '$correo' AND idUsuario !=$idUsuario");
			...
			if($result > 0){
				...
				if(empty($_POST['clave']))
				{
					...
					$sql_update = mysqli_query($conection,"UPDATE usuarios_admin
															SET cedula=$cedula, nombres = '$nombre', apellidos = '$apellidos', correo='$correo', telefono = '$telefono', genero = '$genero', clave = '$clave',rol='$rol'
															WHERE idUsuario= $idUsuario ");

				}

				if($sql_update){
					$alert='<p style="color:green;">Usuario actualizado correctamente.</p>';
				}else{
	...
	$sql= mysqli_query($conection,"SELECT u.idUsuario, u.cedula, u.nombres,u.apellidos,u.correo,u.telefono,u.genero, (u.rol) as idrol, (r.rol) as rol FROM usuarios_admin u INNER JOIN roles r on u.rol = r.idRoles WHERE idUsuario= $iduser");
					...
					<div class="row">
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="lista_admins.php">Lista Usuarios</a></li>
		...
		<div style="color: red;"><?php echo isset($alert) ? $alert : ''; ?></div>
			<div class="row">
				...
				<div class="col-md-6 col-sm-12">
					<div class="form-group">
						<label>Cedula</label>
						<input type="number" value="<?php echo $cedula; ?>"  name="cedula" class="form-control">
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-md-6 col-sm-12">
					<div class="form-group">
						<label>Nombres</label>
						<input type="text" value="<?php echo $nombres; ?>" name="nombre" class="form-control">
					</div>
				</div>
				<div class="col-md-6 col-sm-12">
					<div class="form-group">
			...
			<div class="row">
				...
				<div class="col-md-6 col-sm-12">
					<div class="form-group">
						...
						<input type="tel" value="<?php echo $telefono; ?>" name="telefono" class="form-control">
					</div>
				</div>
			...
			<div class="col-md-12 col-sm-12" >
					<input type="submit" class="btn btn-outline-success" value="Actualizar usuario" >
				</div>
			</div>
