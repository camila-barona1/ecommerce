...
if(isset($_POST["export"]))
{
  ...
  $active_sheet->setCellValue('B1', 'categorias');
  ...
  foreach($res as $row)
  {
    $active_sheet->setCellValue('A' . $count, $row["idCategorias"]);
    $active_sheet->setCellValue('B' . $count, $row["categoria"]);
			...
			<div class="min-height-200px">
              ...
              <div class="row">
				...
				<div class="card-box mb-30">
					<div class="pd-20">
						<h4 class="text-blue h4">Lista categorias</h4>
					</div>
