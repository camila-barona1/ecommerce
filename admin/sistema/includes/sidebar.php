<div class="left-side-bar">
		<div class="brand-logo">
			<a href="index.php">
				...
				<!-- <img src="vendors/images/deskapp-logo-white.svg" alt="" class="light-logo"> -->SHOP
			</a>
		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
					...
					<li class="dropdown">
						<a href="javascript:;" class="dropdown-toggle">
							<span class="micon dw dw-user-13"></span><span class="mtext">Administrador</span>
						</a>
						<ul class="submenu">
							<li><a href="registro_admins.php">Nuevo Administrador</a></li>
							<li><a href="lista_admins.php">Lista Administrador</a></li>
						</ul>
					</li>
					<!-- CATEGORIA -->
					<li class="dropdown">
