<?php 
	...
	if(!empty($_POST))
	{
		...
		if(empty($_POST['cedula']) || empty($_POST['nombre']) || empty($_POST['apellidos']) || empty($_POST['correo']) || empty($_POST['rol']) || empty($_POST['telefono']) || empty($_POST['genero']))
		{
			...
			$query = mysqli_query($conection,"SELECT * FROM usuarios WHERE correo = '$correo' AND idUsuario !=$idUsuario");
	...
	$sql= mysqli_query($conection,"SELECT u.idUsuario, u.cedula, u.nombres,u.apellidos,u.correo,u.telefono,u.genero, (u.rol) as idrol, (r.rol) as rol FROM usuarios u INNER JOIN roles r on u.rol = r.idRoles WHERE idUsuario= $iduser");
					...
					<div class="row">
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									<li class="breadcrumb-item"><a href="lista_usuarios.php">Lista Usuarios</a></li>
