<?php 
	...
	if (isset($_GET['type']) && $_GET['type']!='') {
		...
		if($type =='delete'){
			...
			$delete_sql=" delete from contactos where idContactos='$id'";
						...
						<div class="col-md-6 col-sm-12">
							...
							<nav aria-label="breadcrumb" role="navigation">
								<ol class="breadcrumb">
									...
									<li class="breadcrumb-item active" aria-current="page">Lista Contactos</li>
								</ol>
							</nav>
						</div>
					...
					<table class="table table-striped">
						...
						<tbody>
							...
							<?php 
								...
								echo "<button type='button' class='btn btn-danger'><a style='color:white;' href='?type=delete&id=".$row['idContactos']."'>Eliminar</a></button>";
