			...
			<div class="min-height-200px">
				...
				<div class="pd-20 card-box mb-30">
					<div class="clearfix mb-20">
						<div class="pull-left">
							<h4 class="text-blue h4">Ordenes</h4>
					...
					<table class="table table-striped">
						...
						<tbody>
							<?php 
                                            $res=mysqli_query($conection, "SELECT orden.*, orden_status.nombre as orden_status_str FROM orden, orden_status WHERE orden_status.idOrdenStatus=orden.orden_status");
                                            while ($row=mysqli_fetch_assoc($res)) {
                                             ?>

                                            <tr>
                                                <td><a href="order_master_detail.php?id=<?php echo $row['idOrden'] ?>"><?php echo $row['idOrden'];  ?></a></td>
