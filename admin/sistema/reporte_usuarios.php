...
use PhpOffice\PhpSpreadsheet\Spreadsheet;
	...
	$sql = "SELECT idUsers,nombre,email,telefono,added_on FROM users 
    WHERE 1";
...
if(isset($_POST["export"]))
{
  ...
  $active_sheet->setCellValue('E1', 'Fecha registro');
  ...
  foreach($res as $row)
  {
    $active_sheet->setCellValue('A' . $count, $row["idUsers"]);
    ...
    $active_sheet->setCellValue('E' . $count, $row["added_on"]);
  ...
  $file_name = 'Reporte Usuarios.' . strtolower($_POST["file_type"]);
