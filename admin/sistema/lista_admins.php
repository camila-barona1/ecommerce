...
<body>
	...
	<div class="main-container">
		...
		<div class="pd-ltr-20 xs-pd-20-10">
			...
			$query = mysqli_query($conection,"SELECT u.idUsuario, u.cedula, u.nombres, u.apellidos, u.correo, u.telefono, u.genero, r.rol FROM usuarios_admin u INNER JOIN roles r ON u.rol = r.idRoles WHERE status = 1 
				");
			...
			?>
				...
				<tr>
					<td class="table-plus"><?php echo $data["idUsuario"]; ?></td>
