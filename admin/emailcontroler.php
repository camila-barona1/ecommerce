 ...
 function sendPasswordResetLink($userEmail,$token)
   ...
   // $mensaje = $_POST["mensaje"];
    ...
    try {
      ...
      //  $mail->Body    = $mensaje;
          $mail->Body    = "<strong> Señor(a), <br> Porfavor ingresa al link para resetear tu contraseña <br> <a href='http://127.0.0.1/systema_pos/admin/index.php?password-token=".$token."'>Reset</a>";
          //cambiarbURL
