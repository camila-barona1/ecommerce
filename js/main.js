...
/*-----------------------------------------------
  ...
  function send_message() {
    ...
    if (name=="") {
      ...
      alert('Porfavor ingresa tu correo');
    }else if(tel==""){
      alert('Porfavor ingresa tu telefono');
    }else if(mensaje==""){
      alert('Porfavor ingresa tu mensaje');
    }else{
      jQuery.ajax({
        url:'send_message.php',
        type:'post',
        data:'name='+name+'&email='+email+'&tel='+tel+'&mensaje='+mensaje,
  ...
  function registro_usuario() {
    ...
    var is_error='';
    if (name=="") {
      jQuery('#name_error').html('Porfavor ingresa tu nombre');
      var is_error='yes';

    }if (email=="") {
      jQuery('#email_error').html('Porfavor ingresa tu email');
      var is_error='yes';

    }if (telefono=="") {
      jQuery('#telefono_error').html('Porfavor ingresa tu telefono');
      var is_error='yes';

    }if (password=="") {
      jQuery('#password_error').html('Porfavor ingresa tu contraseña');
      var is_error='yes';
      ...
      jQuery.ajax({
        ...
        success:function(result) {
          if (result=='email_present') {
            jQuery('#email_error').html('Email ya existe');
          }
          if (result=='insert') {
            jQuery('.register_msg p').html('Gracias por registrarte!');
          }
        }
      });
    }
